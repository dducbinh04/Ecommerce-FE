        ...
        <section id="categories" className="bg-white py-20">
            <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-10">
                <div className="mb-10 flex items-end justify-between gap-6">
                    ...
                    <Link className="shrink-0 border-b border-luxe-ink text-xs font-bold text-luxe-ink" to="/products">
                        Xem tất cả
                    </Link>
                </div>
    ...
    return (
        <article className={`group relative overflow-hidden bg-luxe-container ${large ? "min-h-[560px]" : "min-h-[268px]"}`}>
            ...
            <div className="absolute inset-x-0 bottom-0 p-7 text-white">
                ...
                {large ? (
                    <Link className="mt-5 inline-flex bg-white px-5 py-3 text-xs font-bold uppercase text-luxe-primary transition hover:bg-luxe-surface" to="/products">
                        {category.cta}
                    </Link>
                ) : null}
            </div>
